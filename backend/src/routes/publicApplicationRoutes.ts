...
import { searchSlpaEmployee, lookupStudentByNic, submitPublicApplication } from '../controllers/publicApplicationController';
const router = Router();
...
router.get('/students/lookup-nic', limit, lookupStudentByNic);
