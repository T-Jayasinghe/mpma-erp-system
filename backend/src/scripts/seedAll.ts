...
const seedAll = async () => {
  try {
    ...
    const seededCourses = await Course.bulkCreate(courseDataList);
    ...
    const seededClassrooms = await Classroom.bulkCreate(classroomsToCreate);
    ...
    const seededVehicles = await Vehicle.bulkCreate(vehicleTemplates);
    ...
    await VerificationChecklist.create({
    ...
    await VerificationChecklist.create({ student_id: student7.id, identity_verified: false, documents_complete: false, eligibility_verified: false, course_available: true, checked_by: null, checked_at: null });
    ...
    await VerificationChecklist.create({ student_id: student8.id, identity_verified: true, documents_complete: true, eligibility_verified: true, course_available: true, checked_by: 'Training Officer', checked_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000) });
    await StudentPayment.create({ student_id: student8.id, course_batch_id: null, registration_fee: 2500, course_fee: 25000, full_amount_payable: 27500, amount_paid: 0, payment_method: 'GOVPAY', payment_status: 'PENDING', payment_completed: false, payment_reference: `STU-PAY-20260808-${student8.id.substring(0, 8)}-1` });
    ...
    await VerificationChecklist.create({ student_id: student10.id, identity_verified: false, documents_complete: true, eligibility_verified: false, course_available: true, checked_by: null, checked_at: null });
    ...
    await VerificationChecklist.create({ student_id: student11.id, identity_verified: false, documents_complete: false, eligibility_verified: false, course_available: true, checked_by: 'Training Officer', checked_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) });
    ...
    await VerificationChecklist.create({ student_id: student13.id, identity_verified: true, documents_complete: false, eligibility_verified: false, course_available: false, checked_by: 'Training Officer', checked_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000) });
    ...
    await VerificationChecklist.create({ student_id: student16.id, identity_verified: true, documents_complete: false, eligibility_verified: false, course_available: true, checked_by: null, checked_at: null });
    ...
    await VerificationChecklist.create({ student_id: student18.id, identity_verified: true, documents_complete: true, eligibility_verified: true, course_available: true, checked_by: 'Training Officer', checked_at: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000) });
    await StudentPayment.create({ student_id: student18.id, course_batch_id: null, registration_fee: 2500, course_fee: 25000, full_amount_payable: 27500, amount_paid: 0, payment_method: 'GOVPAY', payment_status: 'PENDING', payment_completed: false, payment_reference: `STU-PAY-20260805-${student18.id.substring(0, 8)}-1` });
    ...
    await VerificationChecklist.create({ student_id: student19.id, identity_verified: true, documents_complete: false, eligibility_verified: false, course_available: true, checked_by: null, checked_at: null });
    ...
    await VerificationChecklist.create({ student_id: student20.id, identity_verified: false, documents_complete: false, eligibility_verified: false, course_available: true, checked_by: 'Training Officer', checked_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000) });
